...
1. @symeneses, @alporter08 [pymc-data-umbrella PR#219](https://github.com/pymc-devs/pymc-data-umbrella/pull/219)
1. @reshamas, @vsaitejaswie [pymc-data-umbrella PR#221](https://github.com/pymc-devs/pymc-data-umbrella/pull/221)
1. @SangamSwadiK, @iykat [pymc-data-umbrella PR#224](https://github.com/pymc-devs/pymc-data-umbrella/pull/224)

### Doc / Code contributions
1. @BerylKanali, @Monsurat-Onabajo [pymc-examples PR#538](https://github.com/pymc-devs/pymc-examples/pull/538)
1. @SangamSwadiK, @iykat [pymc PR#6635](https://github.com/pymc-devs/pymc/pull/6635)
1. @symeneses, @alporter08 [pymc PR#6638](https://github.com/pymc-devs/pymc/pull/6638)
